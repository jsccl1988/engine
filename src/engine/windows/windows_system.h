...
#ifndef __VE_WINDOWS_SYSTEM_H__
#define __VE_WINDOWS_SYSTEM_H__
...
/**
    WindowSystem class implementation for Windows.
*/
class WindowsSystem : public WindowSystem {
private:
  ...
  struct WindowInfo {
    ...
    WindowInfo(Window *theWindow, HWND theHWND, HDC theHDC, HGLRC theHGLRC) {
      window = theWindow;
      hWnd = theHWND;
      hDC = theHDC;
      hGLRC = theHGLRC;
  ...
  std::vector<WindowInfo> windowsData;
  Handle registerWindow(Window* window, HWND hWnd, HDC hDC, HGLRC hGLRC);
...
and width, height parameters will be ignored.
  ...
  */
  ...
  /**
      ...
      */
  virtual uint getTextWidth(ve::Font *font, std::string str);
  ...
  /**
      ...
      bu this WindowSystem.
  */
  virtual uint getTextWidth(ve::Font *font, std::wstring wstr);
